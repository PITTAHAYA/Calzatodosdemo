...
export const megaMenus: Record<"mujer" | "hombre" | "ninos", MegaMenuColumn> = {
  mujer: {
    ...
    links: [
      ...
      { label: "Calzado casual", href: "/catalogo?audience=mujer&categoria=casual" },
      { label: "Sandalias", href: "/catalogo?audience=mujer&categoria=sandalias" },
      { label: "Botas y botines", href: "/catalogo?audience=mujer&categoria=botas" },
      { label: "Tacones", href: "/catalogo?audience=mujer&categoria=tacones" },
      { label: "Baletas", href: "/catalogo?audience=mujer&categoria=baletas" },
      { label: "Mocasines", href: "/catalogo?audience=mujer&categoria=mocasines" },
      { label: "Deportivo", href: "/catalogo?audience=mujer&categoria=deportivo" },
  ...
  hombre: {
    ...
    links: [
      ...
      { label: "Calzado casual", href: "/catalogo?audience=hombre&categoria=casual" },
      { label: "Zapatos formales", href: "/catalogo?audience=hombre&categoria=formal" },
      { label: "Botas", href: "/catalogo?audience=hombre&categoria=botas" },
      { label: "Deportivo", href: "/catalogo?audience=hombre&categoria=deportivo" },
      { label: "Outdoor", href: "/catalogo?audience=hombre&categoria=outdoor" },
      { label: "Sandalias", href: "/catalogo?audience=hombre&categoria=sandalias" },
      { label: "Mocasines", href: "/catalogo?audience=hombre&categoria=mocasines" },
      { label: "Zapatos de seguridad", href: "/catalogo?audience=hombre&categoria=seguridad" },
  ...
  ninos: {
    ...
    links: [
      ...
      { label: "Infantil", href: "/catalogo?audience=infantil" },
      { label: "Escolar", href: "/catalogo?categoria=escolar" },
      { label: "Sneakers", href: "/catalogo?audience=nino&categoria=sneakers" },
      { label: "Sandalias", href: "/catalogo?audience=nino&categoria=sandalias" },
      { label: "Botas y botines", href: "/catalogo?audience=nino&categoria=botas" },
      { label: "Zapatos con luces", href: "/catalogo?categoria=luces" },
      { label: "Deportivo", href: "/catalogo?audience=nino&categoria=deportivo" },
